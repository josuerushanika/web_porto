...
import path from "../Images/jojo.jpg";
    ...
    return(
        <div className="about-container content-center flex flex-col p-36" id="about">
            ...
            <div className="content py-20 md:text-2xl text-white w-1/2 flex ">
                <p>
                Hello, my name is Josue Rushanika and I am a  <span className="text-coding-color"> full-stack developer || Cyber Security || Network Engineer</span> with expertise in JavaScript, React,SQL,Redux, and Rails.
                I am a Tech Innovator, and Web developer and tech enthusiast who is passionate about building scalable efficient web applications and managing and optimizing complex IT infrastructures, including server
                 administration, network configuration, and troubleshooting.
                I am currently working on a few personal projects, I am looking for a full time job  
