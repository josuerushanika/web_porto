    ...
    return(
        <div className="about-container content-center flex flex-col p-36" id="about">
            ...
            <div className="content py-20 md:text-2xl text-white w-1/2 flex ">
                <p>
                Hello, my name is Josue Rushanika and I am a  <span className="text-coding-color"> full-stack developer </span> with expertise in JavaScript, React, Redux, and Rails.
